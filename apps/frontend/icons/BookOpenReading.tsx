export const BookOpenReading = ( {className}: {className?: string} ) => {
    return (
        <svg className={`${className}`} stroke="currentColor" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
