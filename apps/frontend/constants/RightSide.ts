export const tryMoreActivities = [
    ...
    },
    {
      ...
      img: 'assets/Activities/BlockPartyActivity.svg',
    },
    {
      title: 'Cells',
      description:
